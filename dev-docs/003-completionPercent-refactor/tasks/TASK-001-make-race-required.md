...
- [x] `race` field is required in `CharacterBasicsSchema`
- [x] `CharacterBasics` type reflects required `race`
- [x] `createInitialState()` still defaults to "Human"
- [x] No TypeScript errors in consuming packages
