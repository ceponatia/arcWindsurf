...
- [ ] Hint displays when no values exist
- [ ] Hint disappears after adding first value
- [ ] Hint is subtle, not blocking
- [ ] Does not affect completion percentage
- [ ] Does not block save
- [ ] Styling consistent with other hints/help text
