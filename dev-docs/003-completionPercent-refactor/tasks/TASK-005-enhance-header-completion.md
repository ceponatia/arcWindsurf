...
- [ ] Completion percentage displays in header
- [ ] Progress bar shows visual fill
- [ ] Percentage updates reactively as fields are filled
- [ ] 100% shows success state (green/checkmark)
- [ ] Missing fields list accessible (tooltip or inline)
