...
- [x] `REQUIRED_FIELDS` constant exported from signals
- [x] `requiredFieldsCompletion` tracks only 6 required fields
- [x] `completionScore` calculates percentage from 6 fields only
- [x] Empty strings and "Select..." values count as incomplete
- [x] 0% when no required fields filled
- [x] 100% when all 6 required fields filled
- [x] Partial completion shows correct percentage (e.g., 3/6 = 50%)
