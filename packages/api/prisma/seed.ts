    ...
    await prisma.message.createMany({
      data: [
        ...
        },
        {
          ...
          idx: 2,
          role: 'assistant',
          content: 'The harbor bells hush under the fog. Aria tucks a charm into her glove and murmurs, "Stormlight walks the piers when the fog tastes of iron. Stay close."',
        },
      ],
    })
  }
