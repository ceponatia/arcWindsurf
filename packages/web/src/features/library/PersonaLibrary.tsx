    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Manage your player character personas</p>
        </div>
      ...
      {loading && <div className="text-center py-12 text-slate-400">Loading personas…</div>}
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {personas.map((persona) => (
            ...
            >
              ...
              <p className="text-sm text-slate-400 mt-2 line-clamp-2">{persona.summary}</p>
            </button>
          ))}
        </div>
      )}
